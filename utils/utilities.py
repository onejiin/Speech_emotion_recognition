...
def get_data_IEMCAP(data_path: str, flatten: bool = True, mfcc_len: int = 39,
             class_labels: Tuple = ("Neutral", "Angry", "Happy", "Sad")) -> \
        Tuple[np.ndarray, np.ndarray]:
                ...
                if (sess[7] == 'i'):
                    ...
                    for filename in files:
                        ...
                        if (emotion in ['hap', 'ang', 'neu', 'sad']):
                            feature_vector = get_feature_vector_from_mfcc(file_path=filename,
                                                                          mfcc_len=mfcc_len,
                                                                          flatten=flatten)
                            data.append(feature_vector)
                            if emotion == 'neu':
                                ...
                                raise ValueError('strange label :', emotion)
                            labels.append(i)
